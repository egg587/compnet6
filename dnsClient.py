...
def dns_query(type, name, server):
    ...
    server_address = (server, 53) # RJB - Enter Port Number
    ...
    # RJB - Sent message equal to header + question
    ...
    # RJB - Parse the response question section (same as query)
    ...
    # RJB - Parse the response answer section
    ...
    for _ in range(ANCOUNT):
        ...
        # RJB - Parse the type, class, TTL, and RDLENGTH
        ...
        offset += 10 # RJB - Same value as just calculated
